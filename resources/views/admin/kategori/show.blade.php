...
<div class="headtitle">    
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li>
                <a href="{{ route('kategori.tambah') }}"><i class="iconfa-plus-sign"></i>&nbsp;Tambah Kategori</a>
            </li>
        </ul>
    </div>
    <h4 class="widgettitle">Tabel List Kategori</h4>
