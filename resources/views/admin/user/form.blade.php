...
<div class="par control-group {{ $errors->has('departemen_id')?'error':'' }}">
    <label class="control-label">Departemen <small>(Wajib Diisi)</small></label>
    <div class="field">
        {!! Form::hidden('departemen_id',null,['id' => 'departemen_id', 'class' => 'input-xxlarge']) !!}
        {!! $errors->first('departemen_id','<span class="help-inline warning">:message</span>') !!}
    </div>                
</div>
